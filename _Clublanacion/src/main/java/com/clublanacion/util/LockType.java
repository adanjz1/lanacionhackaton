...
public class LockType {
    /**
     * This constant means that android using some unlock method not described
     * here. Possible new methods would be added in the future releases.
     */
    public final static int SOMETHING_ELSE = 0;
    /**
     * Android using "None" or "Slide" unlock method. It seems there is no way
     * to determine which method exactly used. In both cases you'll get
     * "PASSWORD_QUALITY_SOMETHING" and "LOCK_PATTERN_ENABLED" == 0.
     */
    public final static int NONE_OR_SLIDER = 1;
    /**
     * Android using "Face Unlock" with "Pattern" as additional unlock method.
     * Android don't allow you to select "Face Unlock" without additional unlock
     * method.
     */
    public final static int FACE_WITH_PATTERN = 3;
    /**
     * Android using "Face Unlock" with "PIN" as additional unlock method.
     * Android don't allow you to select "Face Unlock" without additional unlock
     * method.
     */
    public final static int FACE_WITH_PIN = 4;
    /**
     * Android using "Face Unlock" with some additional unlock method not
     * described here. Possible new methods would be added in the future
     * releases. Values from 5 to 8 reserved for this situation.
     */
    ...
    /**
     * Android using "Password" unlock method with password containing only
     * letters.
     */
    public final static int PASSWORD_ALPHABETIC = 12;
    /**
     * Android using "Password" unlock method with password containing both
     * letters and numbers.
     */
    ...
    /**
     * Returns current unlock method as integer value. You can see all possible
     * values above
     *
     * @param contentResolver we need to pass ContentResolver to
     *                        Settings.Secure.getLong(...) and Settings.Secure.getInt(...)
     * @return current unlock method as integer value
     */
    public static int getCurrent(ContentResolver contentResolver) {
        long mode = android.provider.Settings.Secure.getLong(contentResolver,
                PASSWORD_TYPE_KEY,
        ...
        if (mode == DevicePolicyManager.PASSWORD_QUALITY_SOMETHING) {
            ...
            String dataDirPath = Environment.getDataDirectory()
                    .getAbsolutePath();
